...
export async function GET(request: NextRequest) {
  try {
    ...
    const stats = {
      ...
      avgBidAmount: parseFloat(bidMetrics[0]?.avg_bid_amount || "0"),
      avgResponseTime: parseFloat(auctionMetrics[0]?.avg_response_time_ms || "0"),
      avgDuration: parseFloat(auctionMetrics[0]?.avg_duration_ms || "0"),
      ...
      totalRevenue: parseFloat(revenueMetrics[0]?.total_revenue || "0"),
